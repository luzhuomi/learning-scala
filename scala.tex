...
\end{itemize}
 ...
 \item Concurrent programming with threads and actors
\end{itemize}
\end{frame}
...
\begin{frame}[fragile]
\frametitle{Type classes}
For real world application, we do not define all the type classes from
...
\begin{frame}[fragile]
\frametitle{Data Parallelism}
{\tt .par} converts a sequentials data collection into a paralleled
